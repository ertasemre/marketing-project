...
const Signup = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      // Bu sadece bir gecikme simülasyonu, gerçek uygulamada API çağrısı yapılacak
      await new Promise(resolve => setTimeout(resolve, 1000));
      
      // Kayıt simülasyonu
      localStorage.setItem('auth_token', 'new_user_token_456');
      navigate('/dashboard');
    } catch (err) {
  ...
  const handleGoogleSignup = () => {
    ...
    alert('Google ile kayıt özelliği henüz tamamlanmadı');
  };

  const handleMetaSignup = () => {
    // Meta OAuth entegrasyonu burada gerçekleştirilecek
    alert('Meta ile kayıt özelliği henüz tamamlanmadı');
  };
          ...
          <form className="space-y-6" onSubmit={handleSignup}>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 block text-sm text-gray-900">
                <span>
                  <a href="#" className="text-primary hover:text-primary-dark">Kullanım şartlarını</a> ve <a href="#" className="text-primary hover:text-primary-dark">gizlilik politikasını</a> kabul ediyorum
                </span>
              </label>
            </div>
